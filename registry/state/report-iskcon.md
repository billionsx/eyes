...
Файлов просмотрено: 118 · правила: AE1, AE2, AE3, AE4, AE6, AE7, AE8, AE9, AE10, AE11, AE12, AE13, AE14, AE15, AE18 · находок: 217
...
- `apps/web/src/music/music.css:69` — кегль задан жёстким px в 116 местах против 0 масштабируемых — интерфейс не переживёт Dynamic Type; 🍎 Apple растит кегль от xSmall к xxxLarge на 18 % (34→40 pt у Large Title), на ступенях доступности кратно (/design/human-interface-guidelines/typography)
...
- `apps/web/src/ui/globals.css:625` — свечение/тень на чёрном холсте запрещены (box/text-shadow, drop-shadow) — глубина = ступень поверхности
- `apps/web/src/ui/globals.css:1250` — свечение/тень на чёрном холсте запрещены (box/text-shadow, drop-shadow) — глубина = ступень поверхности
