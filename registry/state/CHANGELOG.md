...
- ЗКН-С004 (ст. 44.1): суд объявляет инструменты первым чеком и падает
...
- конституция: редакция 6 · ст. 46 «Суверенитет» (вместо «Переносимости») ·
  ст. 57 «Паспорт проекта» · ст. 45.1 «Пустой обход» (ЗКН-Х001);
  мандат — 46 доменов
...
- ЗКН-Х001 обнаружен живьём при переносе: линт брал project_root из
